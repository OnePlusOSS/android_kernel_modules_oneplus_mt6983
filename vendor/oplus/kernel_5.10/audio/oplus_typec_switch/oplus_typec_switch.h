...
enum TYPEC_AUDIO_SWITCH_STATE {
	...
	TYPEC_AUDIO_SWITCH_STATE_FAST_CHG = 0x0,
	TYPEC_AUDIO_SWITCH_STATE_AUDIO,
	TYPEC_AUDIO_SWITCH_STATE_UNKNOW,
	TYPEC_AUDIO_SWITCH_STATE_SUPPORT = 4,
	TYPEC_AUDIO_SWITCH_STATE_NO_RAM,
	TYPEC_AUDIO_SWITCH_STATE_I2C_ERR = 8,
	TYPEC_AUDIO_SWITCH_STATE_INVALID_PARAM,
};
